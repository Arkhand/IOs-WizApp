...
open class Customer: EntityValue, Identifiable {
    ...
    open var customerID: String? {
        get {
            return StringValue.optional(optionalValue(for: Customer.customerID))
        }
        set(value) {
            setOptionalValue(for: Customer.customerID, to: StringValue.of(optional: value))
        }
    }
    ...
    open var dateOfBirth: LocalDateTime? {
        get {
            return LocalDateTime.castOptional(optionalValue(for: Customer.dateOfBirth))
        }
        set(value) {
