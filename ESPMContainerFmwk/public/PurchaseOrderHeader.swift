...
open class PurchaseOrderHeader: EntityValue, Identifiable {
    ...
    open var purchaseOrderID: String? {
        get {
            return StringValue.optional(optionalValue(for: PurchaseOrderHeader.purchaseOrderID))
        }
        set(value) {
            setOptionalValue(for: PurchaseOrderHeader.purchaseOrderID, to: StringValue.of(optional: value))
        }
    }
    ...
    open var supplierDetails: Supplier? {
        get {
            return CastOptional<Supplier>.from(optionalValue(for: PurchaseOrderHeader.supplierDetails))
        }
        set(value) {
            setOptionalValue(for: PurchaseOrderHeader.supplierDetails, to: value)
        }
    }
    ...
    open var supplierID: String? {
        get {
            return StringValue.optional(optionalValue(for: PurchaseOrderHeader.supplierID))
        }
        set(value) {
            setOptionalValue(for: PurchaseOrderHeader.supplierID, to: StringValue.of(optional: value))
        }
    }
