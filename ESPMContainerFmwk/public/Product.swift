...
open class Product: EntityValue, Identifiable {
    ...
    open var productID: String? {
        get {
            return StringValue.optional(optionalValue(for: Product.productID))
        }
        set(value) {
            setOptionalValue(for: Product.productID, to: StringValue.of(optional: value))
        }
    }
    ...
    open var stockDetails: Stock? {
        get {
            return CastOptional<Stock>.from(optionalValue(for: Product.stockDetails))
        }
        set(value) {
            setOptionalValue(for: Product.stockDetails, to: value)
        }
    }
    ...
    open var supplierDetails: Supplier? {
        get {
            return CastOptional<Supplier>.from(optionalValue(for: Product.supplierDetails))
        }
        set(value) {
            setOptionalValue(for: Product.supplierDetails, to: value)
        }
    }
    ...
    open var supplierID: String? {
        get {
            return StringValue.optional(optionalValue(for: Product.supplierID))
        }
        set(value) {
            setOptionalValue(for: Product.supplierID, to: StringValue.of(optional: value))
        }
    }
    ...
    open var updatedTimestamp: LocalDateTime? {
        get {
            return LocalDateTime.castOptional(optionalValue(for: Product.updatedTimestamp))
        }
        set(value) {
            setOptionalValue(for: Product.updatedTimestamp, to: value)
        }
    }
