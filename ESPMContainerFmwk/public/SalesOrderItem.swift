...
open class SalesOrderItem: EntityValue, Identifiable {
    ...
    open var deliveryDate: LocalDateTime? {
        get {
            return LocalDateTime.castOptional(optionalValue(for: SalesOrderItem.deliveryDate))
        }
        set(value) {
    ...
    open var productDetails: Product? {
        get {
            return CastOptional<Product>.from(optionalValue(for: SalesOrderItem.productDetails))
        }
        set(value) {
            setOptionalValue(for: SalesOrderItem.productDetails, to: value)
        }
    }
    ...
    open var productID: String? {
        get {
            return StringValue.optional(optionalValue(for: SalesOrderItem.productID))
        }
        set(value) {
            setOptionalValue(for: SalesOrderItem.productID, to: StringValue.of(optional: value))
        }
    }
    ...
    open var quantity: BigDecimal? {
        get {
            return DecimalValue.optional(optionalValue(for: SalesOrderItem.quantity))
        }
        set(value) {
            setOptionalValue(for: SalesOrderItem.quantity, to: DecimalValue.of(optional: value))
        }
    }
    ...
    open var salesOrderID: String? {
        get {
            return StringValue.optional(optionalValue(for: SalesOrderItem.salesOrderID))
        }
        set(value) {
            setOptionalValue(for: SalesOrderItem.salesOrderID, to: StringValue.of(optional: value))
        }
    }
