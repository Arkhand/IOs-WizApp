...
open class Stock: EntityValue, Identifiable {
    ...
    open var lotSize: BigDecimal? {
        get {
            return DecimalValue.optional(optionalValue(for: Stock.lotSize))
        }
        set(value) {
            setOptionalValue(for: Stock.lotSize, to: DecimalValue.of(optional: value))
        }
    }
    ...
    open var productDetails: Product? {
        get {
            return CastOptional<Product>.from(optionalValue(for: Stock.productDetails))
        }
        set(value) {
            setOptionalValue(for: Stock.productDetails, to: value)
        }
    }
    ...
    open var productID: String? {
        get {
            return StringValue.optional(optionalValue(for: Stock.productID))
        }
        set(value) {
            setOptionalValue(for: Stock.productID, to: StringValue.of(optional: value))
        }
    }
    ...
    open var quantity: BigDecimal? {
        get {
            return DecimalValue.optional(optionalValue(for: Stock.quantity))
        }
        set(value) {
            setOptionalValue(for: Stock.quantity, to: DecimalValue.of(optional: value))
        }
    }
