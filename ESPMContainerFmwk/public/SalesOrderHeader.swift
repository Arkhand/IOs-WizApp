...
open class SalesOrderHeader: EntityValue, Identifiable {
    ...
    open var createdAt: LocalDateTime? {
        get {
            return LocalDateTime.castOptional(optionalValue(for: SalesOrderHeader.createdAt))
        }
        set(value) {
    ...
    open var customerDetails: Customer? {
        get {
            return CastOptional<Customer>.from(optionalValue(for: SalesOrderHeader.customerDetails))
        }
        set(value) {
            setOptionalValue(for: SalesOrderHeader.customerDetails, to: value)
        }
    }
    ...
    open var customerID: String? {
        get {
            return StringValue.optional(optionalValue(for: SalesOrderHeader.customerID))
        }
        set(value) {
            setOptionalValue(for: SalesOrderHeader.customerID, to: StringValue.of(optional: value))
        }
    }
    ...
    open var salesOrderID: String? {
        get {
            return StringValue.optional(optionalValue(for: SalesOrderHeader.salesOrderID))
        }
        set(value) {
            setOptionalValue(for: SalesOrderHeader.salesOrderID, to: StringValue.of(optional: value))
        }
    }
