...
open class Supplier: EntityValue, Identifiable {
    ...
    open var supplierID: String? {
        get {
            return StringValue.optional(optionalValue(for: Supplier.supplierID))
        }
        set(value) {
            setOptionalValue(for: Supplier.supplierID, to: StringValue.of(optional: value))
        }
    }
