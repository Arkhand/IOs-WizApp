...
open class PurchaseOrderItem: EntityValue, Identifiable {
    ...
    open var productDetails: Product? {
        get {
            return CastOptional<Product>.from(optionalValue(for: PurchaseOrderItem.productDetails))
        }
        set(value) {
            setOptionalValue(for: PurchaseOrderItem.productDetails, to: value)
        }
    }
    ...
    open var productID: String? {
        get {
            return StringValue.optional(optionalValue(for: PurchaseOrderItem.productID))
        }
        set(value) {
            setOptionalValue(for: PurchaseOrderItem.productID, to: StringValue.of(optional: value))
        }
    }
    ...
    open var purchaseOrderID: String? {
        get {
            return StringValue.optional(optionalValue(for: PurchaseOrderItem.purchaseOrderID))
        }
        set(value) {
            setOptionalValue(for: PurchaseOrderItem.purchaseOrderID, to: StringValue.of(optional: value))
        }
    }
    ...
    open var quantity: BigDecimal? {
        get {
            return DecimalValue.optional(optionalValue(for: PurchaseOrderItem.quantity))
        }
        set(value) {
            setOptionalValue(for: PurchaseOrderItem.quantity, to: DecimalValue.of(optional: value))
        }
    }
