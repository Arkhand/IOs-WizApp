...
internal enum ESPMContainerMetadataChanges {
    ...
    private static func merge1(metadata: CSDLDocument) {
        ...
        ESPMContainer.customers = ESPMContainerMetadata.EntitySets.customers
        ESPMContainer.productCategories = ESPMContainerMetadata.EntitySets.productCategories
        ESPMContainer.productTexts = ESPMContainerMetadata.EntitySets.productTexts
        ESPMContainer.products = ESPMContainerMetadata.EntitySets.products
        ESPMContainer.purchaseOrderHeaders = ESPMContainerMetadata.EntitySets.purchaseOrderHeaders
        ESPMContainer.purchaseOrderItems = ESPMContainerMetadata.EntitySets.purchaseOrderItems
        ESPMContainer.salesOrderHeaders = ESPMContainerMetadata.EntitySets.salesOrderHeaders
        ESPMContainer.salesOrderItems = ESPMContainerMetadata.EntitySets.salesOrderItems
        ESPMContainer.stock = ESPMContainerMetadata.EntitySets.stock
        ESPMContainer.suppliers = ESPMContainerMetadata.EntitySets.suppliers
        ...
        if !ProductText.keyID.isRemoved {
            ProductText.keyID = ESPMContainerMetadata.EntityTypes.productText.property(withName: "Id")
        }
