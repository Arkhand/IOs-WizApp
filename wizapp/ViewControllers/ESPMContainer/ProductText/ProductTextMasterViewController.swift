...
class ProductTextMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    public var loadEntitiesBlock: (() async throws -> [ESPMContainerFmwk.ProductText])?
    private var entities: [ESPMContainerFmwk.ProductText] = .init()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "Id", value: "\(productText.keyID!)")
        return cell
    }
