    ...
    override func tableView(_: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 6:
            if !entity.isNew {
                ...
                func loadProperty() async throws -> [PurchaseOrderItem] {
                    try await dataService.loadProperty(PurchaseOrderHeader.items, into: entity)
        ...
        case 7:
            if !entity.isNew {
                ...
                Task.init {
                    do {
                        try await self.dataService.loadProperty(PurchaseOrderHeader.supplierDetails, into: self.entity)
