    ...
    override func tableView(_: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 10:
            if !entity.isNew {
                ...
                func loadProperty() async throws -> [Product] {
                    try await dataService.loadProperty(Supplier.products, into: entity)
        ...
        case 11:
            if !entity.isNew {
                ...
                func loadProperty() async throws -> [PurchaseOrderHeader] {
                    try await dataService.loadProperty(Supplier.purchaseOrders, into: entity)
                    hideFioriLoadingIndicator()
