    ...
    override func tableView(_: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 9:
            if !entity.isNew {
                ...
                func loadProperty() async throws -> [SalesOrderItem] {
                    try await dataService.loadProperty(SalesOrderHeader.items, into: entity)
        ...
        case 10:
            if !entity.isNew {
                ...
                Task.init {
                    do {
                        try await self.dataService.loadProperty(SalesOrderHeader.customerDetails, into: self.entity)
